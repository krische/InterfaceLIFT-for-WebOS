...
AppAssistant.prototype.handleLaunch = function (launchParams) {
    ...
    if (!launchParams)  {
	    ...
	    if (cardStageController) {
            ...
            var stageArguments = {name: InterfaceLIFT.MainStageName, lightweight: true};
        ...
        switch(event.command) {
            ...
            case "do-about":
                currentScene.showAlertDialog({
                        ...
                        message: "Version: #{version}<br/>Application Copyright 2011, krischeonline.com".interpolate({version: InterfaceLIFT.versionString}),
                        choices:[
                            {label:"OK", value:""}],

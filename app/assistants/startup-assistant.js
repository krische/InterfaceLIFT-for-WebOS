...
StartupAssistant.prototype.setup = function() {
	...
	var request = new Ajax.Request('http://webos.interfacelift.com/feed/date.php?res=320x480&start=0&stop=0', {
		method: 'get',
		evalJSON: 'false',
...
StartupAssistant.prototype.getRows = function(transport) {
	...
	if (this.numToDownload == 0) {
		...
		var request = new Ajax.Request('http://webos.interfacelift.com/feed/artist_list.php?res=320x480&threshold=1', {
			method: 'get',
			evalJSON: 'false',
		...
		var downloadURL = 'http://webos.interfacelift.com/feed/date.php?res=320x480&start=0&stop=' + this.numToDownload;
...
StartupAssistant.prototype.getArtists = function(transport){
	...
	var request = new Ajax.Request('http://webos.interfacelift.com/feed/category_list.php?res=320x480&threshold=1', {
		method: 'get',
		evalJSON: 'false',
